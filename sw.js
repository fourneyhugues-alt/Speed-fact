const CACHE='speed-fact-v1-1.2.0';
const CORE=['./','./index.html','./src/styles.css','./src/app.js','./manifest.webmanifest','./assets/icon.svg','./assets/mea-logo.png','./assets/home-hero.jpg','./version.json'];
...
self.addEventListener('fetch',e=>{
  ...
  if(u.pathname.endsWith('/version.json')||u.pathname.endsWith('/index.html')||u.pathname.endsWith('/src/app.js')||u.pathname.endsWith('/src/styles.css')||u.pathname.endsWith('/assets/home-hero.jpg')){
